<ion-view hide-back-button="false" hide-nav-bar="false">
    ...
    <ion-content>
        ...
        <div ng-if="lineasAccionIndividual.datos.video" class="top-relative video-contenedor">
            <iframe class="video" ng-src="{{lineasAccionIndividual.datos.video}}" frameborder="0" allowfullscreen></iframe>
            <div class="hover-video" ng-click="lineasAccionIndividual.reproducirVideo()"></div>
